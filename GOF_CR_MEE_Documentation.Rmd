...
# Fit an M_bh GAM (accounts for behavioral effects and hete.).

mod_mbh_gam <- gam(Y_recap ~ s(body.weight, bs = "ps") + cap_prev, 
               family = binomial(link = "logit"), gamma = 1.4, data = pl_data)

# Fit a M_tbh-type GAM (accounts for time, behavioral effects, and hete.).
...
# To obtain the standard error for the N_hat1, we use a Taylor series approx.
...
## Edinburgh Taxicab (Scheme A) Data (Web Appendix C3)
